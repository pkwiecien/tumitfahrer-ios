...
//  tumitfahrer
//
//  Created by Automotive Service Lab on 06/07/14.
...
//    [tester waitForViewWithAccessibilityLabel:@"Edit Profile View"];
//    
...
//    [tester waitForViewWithAccessibilityLabel:@"Edit Profile View"];
//    
//    [tester clearTextFromViewWithAccessibilityLabel:@"Edit Profile View"];
//    [tester enterText:@"1234567" intoViewWithAccessibilityLabel:@"Edit Profile View"]
//    [tester tapViewWithAccessibilityLabel:@"Save Button"];
//}
@end
