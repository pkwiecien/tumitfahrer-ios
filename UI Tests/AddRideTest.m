...
//[self searchBack];
//[self addRideAsDriverWithCampusRideWithSearch];
...
//    [tester waitForTappableViewWithAccessibilityLabel:@"Repeat View"];
//    [tester waitForTimeInterval:1];
//    CGPoint select;
//    select.x = 20;
//    select.y = 20;
...
//{
//    if(driver){
//        [tester tapRowAtIndexPath:[NSIndexPath indexPathForRow:7 inSection:0] inTableViewWithAccessibilityIdentifier:@"Add Ride List"];
//    }else{
//        [tester tapRowAtIndexPath:[NSIndexPath indexPathForRow:4 inSection:0] inTableViewWithAccessibilityIdentifier:@"Add Ride List"];
//    }
//    
